...
CREATE TABLE `Coupon` (
  ...
  `stop_rules_processing` smallint(6) NOT NULL,
  `sort_order` int(11) NOT NULL,
  `simple_action` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_63133A34812D24CA` (`parc_id`),
  CONSTRAINT `FK_63133A34812D24CA` FOREIGN KEY (`parc_id`) REFERENCES `Parc` (`id`)
...
INSERT INTO `Coupon` VALUES (1,'test','test','12345','2009-01-01','2009-01-01',1,0,0,1,'by_fixed',5,0,1,1);
